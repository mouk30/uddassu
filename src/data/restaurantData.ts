...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    category: 'side',
    price: 5000,
    description: '야채꼼장어 팬에 남은 특제 소스에 김가루와 참기름을 볶아내는 고소한 볶음밥 (야채꼼장어만 가능)',
...
export const SET_MENUS: SetMenuItem[] = [
  {
    ...
    description: '담백 고소한 꼼장어구이 400g과 육즙 가득한 소갈비살 400g의 럭셔리한 조화! 회식과 귀한 손님 접대에 가장 많이 찾는 1위 세트',
    tag: '세트 A 인기 1위',
    popularRank: 1,
  },
  {
    ...
    totalWeight: '총 800g (2인+2인)',
    price: 65000,
    items: ['야채꼼장어 (2인/400g)', '허겁살구이 (2인/400g)'],
    description: '매콤한 호일팬 야채꼼장어 400g과 쫄깃한 명품 뒷고기 허겁살 400g의 황금 밸런스! 단골 고객들의 전폭적인 지지를 받는 세트',
    tag: '세트 B 단골 1위',
    popularRank: 2,
  },
];
