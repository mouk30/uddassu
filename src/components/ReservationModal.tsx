...
import { X, Calendar, Clock, Users, Phone, User, MessageSquare, CheckCircle, Send, MessageCircle } from 'lucide-react';
        ...
        {!isSubmitted ? (
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 rounded-xl bg-neutral-950 border border-neutral-800 text-xs focus:outline-none focus:border-amber-500 text-white placeholder:text-neutral-600"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl bg-neutral-950 border border-neutral-800 text-xs focus:outline-none focus:border-amber-500 text-white"
                  />
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="18:30">18:30 (피크)</option>
                    <option value="19:00">19:00 (피크)</option>
                    <option value="19:30">19:30</option>
                    <option value="20:00">20:00</option>
                    <option value="21:00">21:00</option>
                    <option value="22:00">22:00 이후</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="4">4명 (추천 세트A)</option>
                    <option value="5">5~6명 (단체석)</option>
                    <option value="8">8명 이상 (회식)</option>
                    <option value="15">15명 이상 (전체대관)</option>
                  </select>
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  rows={2}
                  placeholder="예: 조용한 자리 부탁드립니다, 꼼장어 3인분 세트A로 미리 부탁드립니다."
                  value={notes}
              ...
              <div className="pt-2 space-y-2">
                ...
                {STORE_INFO.kakaoOpenChat && (
                  <a
                    ...
                    className="w-full py-3 rounded-xl bg-[#FEE500] hover:bg-[#FFEB00] text-[#371D1E] font-extrabold text-xs flex items-center justify-center gap-2 shadow-md transition-all"
                  >
                ...
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    <span>전화 즉시 통화 ({STORE_INFO.phone})</span>
                  </a>
          ...
          <div className="text-center py-6 space-y-4">
            ...
            <p className="text-xs text-neutral-400 leading-relaxed">
              매장 상황(피크타임 여부 등)에 따라 실시간 확인 후 매장에서 최종 확정 연락을 드립니다. 빠른 확정을 원하시면 카톡 오픈채팅이나 전화로 바로 말씀해주세요.
            </p>
            ...
            {STORE_INFO.kakaoOpenChat && (
              ...
              >
                <MessageCircle className="w-4 h-4 fill-[#371D1E]" />
                <span>카카오톡 1:1 오픈채팅으로 예약 전달하기</span>
              </a>
            )}
